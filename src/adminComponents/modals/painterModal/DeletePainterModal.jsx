...
const DeletePainterModal = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      setLoading(true);
      await axiosInstance.delete(`/customer/${painter.id}`);
      toast.success("Painter deleted successfully");
      closeDeleteModal();
      if (onDelete) onDelete();
    } catch (error) {
      console.error("Failed to delete Painter", error);
      toast.error("Failed to delete Painter");
    } finally {
      setLoading(false);
    }
  };
...
export default DeletePainterModal;
