...
const AddPainterCategoryModal = ({ isOpen, closeCategoryModal, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("/v2/paintercategory", formData);
      toast.success("Painter Category added successfully");
      onUpdate();
...
export default AddPainterCategoryModal;
