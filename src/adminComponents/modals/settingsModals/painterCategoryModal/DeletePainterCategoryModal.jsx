...
const DeletePainterCategoryModal = ({
  isOpen,
  closeDeleteModal,
  category,
  onDelete,
  ...
  const handleDelete = async () => {
    ...
    try {
      setLoading(true);
      await axiosInstance.delete(`/v2/paintercategory/${category.id}`);
            ...
            >
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  ...
                  <strong>{category?.name} Category</strong>? This action cannot
                  be undone.
                </p>
...
export default DeletePainterCategoryModal;
